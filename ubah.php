...
<head>
    ...
    <title>Tambah Data | Fahrizal Angga | CRUD</title>
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
        <div class="container">
            <a class="navbar-brand" href="index.php">Fahrizal Angga | CRUD</a>
        ...
        <div class="row my-2">
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="nim" class="form-label">NIS</label>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select w-50" id="jurusan" name="jurusan">
                            ...
                            <option value="Teknologi Informasi" <?php if ($siswa['jurusan'] == 'Teknologi Informasi') { ?> selected='' <?php } ?>>Teknologi Informasi</option>
                            <option value="Teknik Listrik" <?php if ($siswa['jurusan'] == 'Teknik Listrik') { ?> selected='' <?php } ?>>Teknik Listrik</option>
                            <option value="Teknologi Rekayasa Otomotif" <?php if ($siswa['jurusan'] == 'Teknologi Rekayasa Otomotif') { ?> selected='' <?php } ?>>Teknologi Rekayasa Otomotif</option>
                            <option value="Perkeretaapian" <?php if ($siswa['jurusan'] == 'Perkeretaapian') { ?> selected='' <?php } ?>>Perkeretaapian</option>
                            <option value="Teknik Komputer Kontrol" <?php if ($siswa['jurusan'] == 'Teknik Komputer Kontrol') { ?> selected='' <?php } ?>>Teknik Komputer Kontrol</option>
                            <option value="Teknik Pembentukan Logam" <?php if ($siswa['jurusan'] == 'Teknik Pembentukan Logam') { ?> selected='' <?php } ?>>Teknik Pembentukan Logam</option>
                        </select>
                    </div>
                    <div class="mb-3">
